...
namespace ABZ_Pc
{
    public class Pc_Controller : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            #region Debug gismos
            if (pcMov.debuggerGismos)
            {
                Debug.DrawLine(playerBody.position, sphereMov.velocity, Color.black);
            }
        ...
        public void HorizontalVectorMovInput()
        {
            ...
            {
                case Pc_Movement.MovementType.Walking:
                    pcMov.StrafeInputValue(playerMovinput.x, vamtSetting.horizontalStrafePower, 3);
                    break;


                case Pc_Movement.MovementType.Bursting:
                    pcMov.StrafeInputValue(playerMovinput.x, vamtSetting.horizontalBurstPower, 3);
                    break;
